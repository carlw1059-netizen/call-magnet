...
Deno.serve(async (req) => {
  ...
  if (url.searchParams.get('test') === '1') {
    ...
    const testStats: ClientStats = { smsSent: 47, linkClicks: 23, bookingsLogged: 8, conversionRate: '48.9%', daysUntilRenewal: 14, overage: 0, buttonClicks: [{ intent: '🍽️ Book a table', count: 12 }, { intent: '✏️ Change or cancel my booking', count: 5 }, { intent: '🎁 Function enquiry', count: 3 }], heatmapData: [] };
