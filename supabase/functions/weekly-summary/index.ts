...
Deno.serve(async (req) => {
  ...
  if (url.searchParams.get('test') === '1') {
    ...
    const testStats: ClientStats = { smsSent: 47, linkClicks: 23, bookingsLogged: 8, conversionRate: '48.9%', daysUntilRenewal: 14, overage: 0, buttonClicks: [{ intent: '🍽️ Book a table', count: 12, peakHours: [{ hour: 19, count: 5 }, { hour: 20, count: 4 }, { hour: 18, count: 3 }] }, { intent: '✏️ Change or cancel my booking', count: 5, peakHours: [{ hour: 12, count: 3 }, { hour: 13, count: 2 }] }, { intent: '🎁 Function enquiry', count: 3, peakHours: [{ hour: 17, count: 2 }, { hour: 18, count: 1 }] }], heatmapData: [{ day_of_week: 6, hour_of_day: 20, call_count: 3 }, { day_of_week: 6, hour_of_day: 19, call_count: 2 }, { day_of_week: 5, hour_of_day: 18, call_count: 1 }, { day_of_week: 1, hour_of_day: 12, call_count: 1 }] };
