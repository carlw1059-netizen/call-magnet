...
- **Right after a Netlify deploy updates the dashboard app, the first push can be missed or shown twice while the phone switches to the new version.** Test again a minute later before investigating.
